...
{
    public class HouseholdsModel : PageModel
    {
        private readonly ILogger<HouseholdsModel> _logger;
        ...
        public HouseholdsModel(ILogger<HouseholdsModel> logger, Repository<Guest> guestRepository, Repository<Household> householdRepository)
        {
            _logger = logger;
